...
menu = st.sidebar.selectbox(
    "Filannoo Qabiyyee:",
    [
        "Kitaaba Guutuu (Fuula Jalqabaa & Seensaa)", 
        "H-R Diagram", 
        "P-Pdot Diagram (Neutron Stars)"
    ]
)

# 1. KITAABA GUUTUU (COVER PAGE FI TARTIIBA KITAABAA)
if menu == "Kitaaba Guutuu (Fuula Jalqabaa & Seensaa)":
    # ==========================================
    # A. FUULA JALQABAA (COVER PAGE)
    # ==========================================
    ...
    # B. KUTAA GALATAA
    # ==========================================
    st.markdown("## 🙏 Kutaa Galataa Addaa")
    st.write(
    ...
    # ==========================================
    # C. WAA'EE QORATAA (PROFILE)
    # ==========================================
    st.markdown("## 👤 Waa'ee Qorataa / Profile")
    suuraa_url = "https://raw.githubusercontent.com/kitesanegasa2012-arch/kitesa-Astro/main/qixxeessaa.jpg"
    try:
        st.image(suuraa_url, caption="Barsiisaa Qixxeessaa Nagaasaa", width=220)
    except:
        st.caption("⚠️ *Suuraa argachuuf sarara interneetii qabadhu.*")
    ...
    # ==========================================
    # D. BAAFATA KITAABICHAA
    # ==========================================
    st.markdown("## 📖 Tarreefi Baafata Qabiyyee Kitaabichaa")
    ...
    st.write("**🔭 Hiika Saayinsii Hawwaa fi Astroonoomii:**")
    ...
    # ==========================================
    # F. KAAYYOO FI MUL'ATA
    # ==========================================
    st.markdown("## 🎯 Kaayyoo fi Mul'ata Appilikeeshinichaa")
...
# 2. H-R DIAGRAM (ADDATTI SEPARATE TA'EE)
...
# 3. P-PDOT DIAGRAM (ADDATTI SEPARATE TA'EE)
